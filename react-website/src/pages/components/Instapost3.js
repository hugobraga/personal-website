...
const Instapost3 = (props) => {
  const {
    ...
    caption,
    media,
  } = InstagramMediaParserWithHeader({ uri: props.post });
  //instagramMediaParser({ uri: props.post }).then(post => console.log(post));
  // console.log(caption);
